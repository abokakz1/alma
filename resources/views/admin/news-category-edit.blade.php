        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane in active" id="main_data">
                    ...
                    @endif
                    <form id="myform" method="post" enctype="multipart/form-data" action="/admin/news-category-edit/{{$row->news_category_id}}" style="margin-bottom: 0px;">
                        <div style="float: left; width: 900px;">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <input type="hidden" name="news_category_id" value="{{$row->news_category_id}}">

                            <div class="left-block">
                                <p>Наименование (Каз)</p>
                            </div>
                            <div class="right-block">
                                <input type="text" name="news_category_name_kz" value="{{$row->news_category_name_kz}}">
                            </div>
                            ...
                            <div class="right-block">
                                <input type="text" name="news_category_name_ru" value="{{$row->news_category_name_ru}}">
                            </div>
                            <div class="clearfloat"></div>
                            ...
                            <div class="right-block">
                                <input type="text" name="news_category_name_en" value="{{$row->news_category_name_en}}">
                            </div>
                            <div class="clearfloat"></div>
                        </div>
