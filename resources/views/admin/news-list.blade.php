        ...
        <div class="span12" style="margin-left: 0px;">
            ...
            <form method="post" id="myform" action="/admin/news-list">
                ...
                <div class="right-block">
                    <select name="news_lang_id">
                        <option value="0">Выберите язык</option>
                        <option value="1" @if($news_lang_id == 1) selected @endif>Казахский</option>
                        <option value="2" @if($news_lang_id == 2) selected @endif>Русский</option>
                    </select>
                </div>
                <div class="clearfloat"></div>
            ...
            <div class="clearfloat"></div>
            <input type="button" class="btn btn-primary" value="Удалить отмеченные" style="line-height: normal; padding: 2px 15px; float: right; margin-bottom: 10px; margin-top: 0px;" onclick="deleteSelectedRows('news')">
            <div class="clearfloat"></div>
