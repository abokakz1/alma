        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane in active" id="main_data">
                    ...
                    @endif
                    <form id="myform" enctype="multipart/form-data" method="post" action="/admin/const-tv-programm-edit/{{$row->tv_programm_id}}" style="margin-bottom: 0px;">
                        <div>
                            ...
                            <div style="float: left; margin-left: 100px;">
                                ...
                                <div style="text-align: center; margin: 10px 0px 0px 20px;">
                                    ...
                                    <p style="font-size: 14px; color: red;">Рекомендуемый размер картинки: 615x85</p>
                                </div>
                            </div>
                            <div class="clearfloat"></div>
