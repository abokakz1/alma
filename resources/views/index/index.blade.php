                                    ...
                                    <ul class="latest-news-list">
                                        @if(count($row_new) > 0)
                                            @foreach($row_new as $key => $row_new_item)
                                                @if(strlen($row_new_item['news_title_' . App::getLocale()]) > 0)
                                                    @if($i < 4)
                                                        <?php $i++; ?>
                                                        <li>
                                                            <div class="dv">
...
<!--                    <div class="event-blog-item-top">
                ...
                <div class="index-event-block">
                    ...
                    <div class="index-events" style="padding: 10px 0;">
                        ...
                        @endforeach
                        @if(!Auth::check())
                            <a data-toggle="modal" data-target="#login"><button class="btn-add" >{{ trans('messages.write_blog') }}</button></a>
                        @else
                            <a href="/blogger/blog-edit/0"><button class="btn-add" >{{ trans('messages.write_blog') }}</button></a>
                        @endif
                    </div>
                </div>
                @endif
