                    ...
                    <div class="row">
                        <div class="article-date col-md-7">
                            <ul class="list-inline">
                                ...
                                <?php $view_row = View::where("news_id","=",$row['news_id'])->count(); ?>
                                <li><i class="icon icon-blue-eye"></i><span>{{ $view_row }}</span></li>
                            </ul>
                        </div>
        ...
        @foreach($kz_news_row as $key => $main_news_item)
            @if($i < 4)
                @if(strlen($main_news_item['news_title_' . App::getLocale()]) > 0)
                    <?php $i++; $bb = $i; ?>
                    <?php $view_row = View::where("news_id","=",$main_news_item['news_id'])->count(); ?>
